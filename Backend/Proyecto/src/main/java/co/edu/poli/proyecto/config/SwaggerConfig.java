...
public class SwaggerConfig {
	...
	public Docket estudianteApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.build()
				.apiInfo(mongoEstudianteApiInfo())
				.tags(new Tag("Class: EstudianteController", "*** Estudiante Controller ***"));
	}

	private ApiInfo mongoEstudianteApiInfo() {
		return new ApiInfoBuilder()
				.title("Estudiante")
				.description("Estudiante REST API Spring Boot and Mongo")
				.contact(new Contact("Nicolas // Jonathan", "", "@poligran.edu.co"))
				.version("0.0.1")
				.build();
	}
